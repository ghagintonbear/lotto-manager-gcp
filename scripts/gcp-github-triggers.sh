...
PROJECT_ID="lotto-manager-$1"  # suffix is branch this project is attached to, is the only arg supplied
...
do
    ...
    then
        ...
        gcloud beta builds triggers create github \
            ...
            --substitutions=_FUNCTION_NAME=${FUNCTION_NAME},_RUNTIME=${RUNTIME},_TRIGGER_TYPE=${TRIGGER_TYPE},_MEMORY=${MEMORY},_TIMEOUT=${TIMEOUT},_LOAD_LIBS=${LOAD_LIBS} \
            --project=${PROJECT_ID}
    else
        echo
...
# Move back out of the cloud folder
cd ..
